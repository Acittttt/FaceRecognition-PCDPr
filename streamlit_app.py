    ...
    if uploaded_file is not None:
            ...
            if landmarks is not None:
                try:
                    ...
                    with col1:
                        ...
                        st.image(cv2.cvtColor(aligned_face, cv2.COLOR_BGR2RGB), use_container_width=True)
                except Exception as e:
        ...
        if do_white_balance:
            ...
            with col2:
                ...
                st.image(cv2.cvtColor(normalized_face, cv2.COLOR_BGR2RGB), use_container_width=True)
        ...
        with col_before:
            ...
            st.image(cv2.cvtColor(original_face, cv2.COLOR_BGR2RGB), use_container_width=True)
